...
const heroBanner = function ({ results: mvoieList }) {
    ...
    for (const [index, movie] of mvoieList.entries()) {
        ...
        controlItem.innerHTML = `
            ...
            <img src="${imageBaseURL}w154${poster_path}" alt="Slide to ${title}"
                loading="lazy" draggable="false" class="img-cover"></img>
    ...
    //fetch data from home page section 
...
const addHeroSlide = function () {
    ...
    addEventOnElememts(sliderControls, "click", sliderStart);
}

const createMovieList = function ({ results: mvoieList }, title) {
